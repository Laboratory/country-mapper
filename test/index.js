...
describe('Codes', () => {
  describe('check Veeam', () => {
    it('Veeam specific countries should be found', () => {
  ...
  describe('converter', () => {
    it('should convert from Country to specific code', () => {
  ...
  describe('abbreviation', () => {
    it('should convert from abbreviation of Country to specific code', () => {
  ...
  describe('all countries from countrycode.org', () => {
    it('should be mapped', () => {
  ...
  describe('abbreviation for UK', () => {
    it('should convert from abbreviation of UK code', () => {
  ...
  describe('convert country name to ISO 3166', () => {
